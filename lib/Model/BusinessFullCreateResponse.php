...
/**
 * BusinessFullCreateResponse Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class BusinessFullCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessFullCreateResponse';
    ...
    */
     ...
     * Sets success
     *
     * @param bool $success Indicates if creation was successful
     *
     * @return self
     */
     ...
     * Sets business_id
     *
     * @param string $business_id The newly created business ID
     *
     * @return self
     */
