...
class WithdrawalCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets amount
     *
     * @param float $amount The amount to withdraw in cents (e.g. 1000 for $10.00)
     *
     * @return self
     */
     ...
     *
     * @param string|null $payout_method_id The ID of the payout method to withdraw to. If omitted, default is used.
     *
     * @return self
     */
